...
THREEx.Planets.createEarth	= function(){
	...
	var material	= new THREE.MeshPhongMaterial({
		map: THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL +'./test-earth/images/8k_earth_daymap.jpg'),
		bumpScale	: 0.05,
		specularMap: THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL +'./test-earth/images/earthspec1k.jpg'),
...
THREEx.Planets.createEarthCloud	= function(){
	...
	imageMap.addEventListener("load", function() {
		...
		imageTrans.src = THREEx.Planets.baseURL +'./test-earth/images/earthcloudmaptrans.jpg';
	}, false);
	imageMap.src = THREEx.Planets.baseURL +'./test-earth/images/earthcloudmap.jpg';
